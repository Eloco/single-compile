...
Eg:
      ...
      SharpGetUserLoginIPRPC.exe administrator:password@[email]123@192.168.0.3[/email]  -month 1 # 筛选一个月
      SharpGetUserLoginIPRPC.exe administrator:password@[email]123@192.168.0.3[/email]  -day 1 # 筛选一天
      SharpGetUserLoginIPRPC.exe administrator:password@[email]123@192.168.0.3[/email]  -week 1 # 筛选一星期
      SharpGetUserLoginIPRPC.exe administrator:password@[email]123@192.168.0.3[/email]  -hour 1 # 筛选一个小时
      SharpGetUserLoginIPRPC.exe administrator:password@[email]123@192.168.0.3[/email]  -qu ssoadmin  # 筛选登录用户
      SharpGetUserLoginIPRPC.exe administrator:password@[email]123@192.168.0.3[/email]  -qh 192.168.0.1  # 筛选访问ip或主机名
